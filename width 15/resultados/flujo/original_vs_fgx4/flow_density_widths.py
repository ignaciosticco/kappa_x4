...
### DATA ###
data_modified = np.genfromtxt("flow-density_vd1_pasillo15m_fgx4.txt",delimiter = ' ') 
density_modified = data_modified[:,0]
flow_modified = data_modified[:,1]

data_original = np.genfromtxt("flow-density_vd1_pasillo15m_original.txt",delimiter = ' ') 
