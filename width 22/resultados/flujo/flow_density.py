...
for i in range(1,11):
	data = np.genfromtxt("density_flow_%d_vd1_pasillo22m.txt"%i,delimiter = ' ') 
	density_raw = data[:,2]
	flow_raw = data[:,3]
...
np.savetxt('flow-density_vd1_pasillo22m.txt', output,fmt='%.2f', delimiter=' ')  
###  PLOT  ###
...
pylab.savefig('flow-density_fgwallx4_width22.png', format='png', dpi=300, bbox_inches='tight')