...
data_d2 = np.genfromtxt('speed_profile_w22_density2_kappa96.txt', delimiter = '')
data_d4 = np.genfromtxt('speed_profile_w22_density4_kappa96.txt', delimiter = '')
data_d5 = np.genfromtxt('speed_profile_w22_density5_kappa96.txt', delimiter = '')
data_d6 = np.genfromtxt('speed_profile_w22_density6_kappa96.txt', delimiter = '')
data_d9 = np.genfromtxt('speed_profile_w22_density9_kappa96.txt', delimiter = '')
...
pylab.savefig('v(y)_width22_k96.png', format='png', dpi=300, bbox_inches='tight')
